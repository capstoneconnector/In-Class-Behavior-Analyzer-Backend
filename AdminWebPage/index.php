...
ini_set('display_errors', 1);   
                ...
                if($_SERVER["REQUEST_METHOD"] === "GET"){
                    if(isset($_GET['firstname'])){
                        echo "<h1>First name: " . $_GET['firstname'] . " added to database.</h1>"; 
                        $file = 'config.php';
...
file_put_contents($file, $current);
                    ...
                    if(isset($_GET['lastname'])){
                        echo "<h1>Last name: " . $_GET['lastname'] . " added to database.</h1>"; 
                        $file = 'config.php';
// Open the file to get existing content
$current = file_get_contents($file);
// Append a new person to the file
...
file_put_contents($file, $current);
                    ...
                    if(isset($_GET['username'])){
                        echo "<h1>Username: " . $_GET['username'] . " added to database.</h1>"; 
                        $file = 'config.php';
// Open the file to get existing content
$current = file_get_contents($file);
// Append a new person to the file
...
file_put_contents($file, $current);
                    ...
                    if(isset($_GET['password'])){
                        echo "<h1>Password: (censored) added to database.</h1>"; 
                        $file = 'config.php';
// Open the file to get existing content
$current = file_get_contents($file);
// Append a new person to the file
                ...
                <div class="container">
                    <div class="addUserDiv col-lg-6">
                        <form>
                            ...
                            <!-- Add User Example------------------------------->
                            <form action="user_get.php" target="_blank" method="GET">
