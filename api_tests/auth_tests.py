...
class UserLoginTests(TestCase):
    ...
    def test_session_already_exists(self):
        ...
        first_response = json.loads(login(mock_request).content.decode('utf-8'))
        second_response = json.loads(login(mock_request).content.decode('utf-8'))
...
class ResetPasswordTests(TestCase):
    ...
    def setUp(self):
        ...
        self.new_student = Student.objects.create(user=self.new_user, reset_password_code='ABCDEF')
        self.new_student.save()
